...
const DOCUMENT_LIBRARY: ProcessDocument[] = [
  ...
  },
  {
    ...
    kind: 'Word',
    simulated: true,
    templateType: 'SAMPLE_PRODUCTION_CONTACT',
  },
  {
    id: 'new-product-production-contact',
    name: c(
      'New product production contact',
      'Phiếu liên hệ sản xuất sản phẩm mới',
      '新產品生產聯絡單',
    ),
    kind: 'Word',
    simulated: true,
    templateType: 'NEW_PRODUCT_PRODUCTION_CONTACT',
  },
  {
    id: 'new-product-sample-processing-contact',
    name: c(
      'New product sample processing contact',
      'Phiếu liên hệ xử lý mẫu sản phẩm mới',
      '新產品樣品處理聯絡單',
    ),
    kind: 'Word',
    simulated: true,
    templateType: 'NEW_PRODUCT_SAMPLE_PROCESSING_CONTACT',
  },
  {
    id: 'foreign-return-sample-contact',
    name: c(
      'Foreign return sample contact',
      'Phiếu liên hệ mẫu trả về nước ngoài',
      '國外回樣聯絡單',
    ),
    kind: 'Word',
    simulated: true,
    templateType: 'FOREIGN_RETURN_SAMPLE_CONTACT',
  },
  {
    id: 'sample-shipment-notice',
    name: c(
      'Sample shipment notice',
      'Thông báo gửi mẫu',
      '樣品寄送通知',
    ),
    kind: 'Word',
    simulated: true,
    templateType: 'SAMPLE_SHIPMENT_NOTICE',
  },
  {
    id: 'sample-export-invoice',
    name: c(
      'Sample export invoice',
      'Hóa đơn xuất khẩu mẫu',
      '樣品出口發票',
    ),
    kind: 'Excel',
    simulated: true,
    templateType: 'SAMPLE_EXPORT_INVOICE',
  },
  {
    id: 'coa-attn',
    name: c(
...
const PROCESS_WORKFLOWS: ProcessWorkflow[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        icon: 'SM',
        tone: 'blue',
        documents: ['sample-shipment-notice', 'sample-export-invoice'],
        actions: [
