...
export type RndDocumentType =
  | 'SAMPLE_REPORT'
  | 'FOREIGN_RETURN_SAMPLE_CONTACT'
  | 'NEW_PRODUCT_PRODUCTION_CONTACT'
  | 'NEW_PRODUCT_SAMPLE_PROCESSING_CONTACT'
  | 'SAMPLE_PRODUCTION_CONTACT'
  | 'SAMPLE_SHIPMENT_NOTICE'
  | 'SAMPLE_EXPORT_INVOICE'
